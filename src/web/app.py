...
async def get_config():
    ...
    return {
        ...
        "notifier": {
            ...
            "discord_channel_id": (
                str(config.notifier.discord_channel_id)
                if config.notifier.discord_channel_id
                else None
            ),
...
async def save_config(data: dict):
    try:
        ...
        print(f"  Save config: discord_channel_id={config.notifier.discord_channel_id!r}")
